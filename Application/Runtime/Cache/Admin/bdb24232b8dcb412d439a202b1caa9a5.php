...
.username{float: right;color:#335B64;  background:#80BDCB;padding-right: 30px;}
</style>
...
<div id="header-div">
    <div id="logo-div" style="bgcolor:#000000;">
        <img src="/practice/myproject/Public/Images/ecshop_logo.gif" alt="ECSHOP - power for e-commerce" />
    </div>
    <div id="submenu-div">
        <ul>
        ...
        <div id="send_info">
            ...
            <a href="/practice/myproject/index.php/Admin/login/logout" target="_top" class="fix-submenu">退出</a>
        </div>
    </div>
</div>
<div id="menu-div">
    <ul>
        ...
        <li><a href="/practice/myproject/index.php/Admin/Index" target="main-frame">起始页</a></li>
    ...
    <span class="username">欢迎&nbsp;<?php echo $user;?>&nbsp;登录</span>
    <br class="clear" />
</div>
</body>
</html>