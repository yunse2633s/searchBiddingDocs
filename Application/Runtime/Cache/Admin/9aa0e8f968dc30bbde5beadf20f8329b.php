...
<body>
<h1>
    <span class="action-span"><a href="/practice/myproject/index.php/Admin/Searchhot/add">添加</a></span>
...
<form method="post" action="/practice/myproject/index.php/Admin/Searchhot/bdel" name="listForm">
        ...
        <table cellpadding="3" cellspacing="1">
            ...
            <?php foreach($data as $v):?>            <tr>
                <td align="center"><input class='selall' type="checkbox" name='delid[]' value="<?php echo $v['id'];?>" /></td>
                                ...
                                <td align="center"><?php echo $v['search_hot'];?></td>
                                <td align="center"><?php echo $v['hit_heat'];?></td>
                                <td align="center"><?php echo date('Y-m-d',$v['search_time']);?></td>
                                <td align="center">
                    <a href="/practice/myproject/index.php/Admin/Searchhot/save/id/<?php echo $v['id'];?>" title="编辑">编辑</a>|<a href="/practice/myproject/index.php/Admin/Searchhot/del/id/<?php echo $v['id'];?>" title="移除" onclick="javascript:return confirm('确定删除吗')">移除</a>
                </td>
            </tr>
            <?php endforeach;?>            <tr>
