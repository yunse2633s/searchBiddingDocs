...
<div class="main-div">
    <form method="post" action="/practice/myproject/index.php/Admin/Subject/save/id/9"enctype="multipart/form-data" >
...
$(function(){
    ...
    if(id){
    $.ajax({
        url:'/practice/myproject/index.php/Admin/Subject/ajaxlist/id/'+id,
        dataType:'json',
        type:'get',
        success:function(e){
            console.log(e);
