...
$(function() {
	$.fn.Date_time = function(options) {
		...
		if($("#calender").length<=0){
			...
			$("body").prepend("<div class='calender'><div class='calenderContent'><div class='calenderTable'><div class='getyear'><select id='year'></select><select id='month'></select></div><div class='tablebg'><table id='calender' class='calendertb' cellpadding='0' cellspacing='1'><tr bgcolor='#D6D6D6'><th class='weekend'>日</th><th>一</th><th>二</th><th>三</th><th>四</th><th>五</th><th class='weekend noborder'>六</th></tr><tr><td class='weekend2'></td><td></td><td></td><td></td><td></td><td></td><td class='weekend2 noborder'></td></tr><tr><td class='weekend2'></td><td></td><td></td><td></td><td></td><td></td><td class='weekend2 noborder'></td></tr><tr><td class='weekend2'></td><td></td><td></td><td></td><td></td><td></td><td class='weekend2 noborder'></td></tr><tr><td class='weekend2'></td><td></td><td></td><td></td><td></td><td></td><td class='weekend2 noborder'></td></tr><tr><td class='weekend2'></td><td></td><td></td><td></td><td></td><td></td><td class='weekend2'></td></tr><tr><td class='weekend2'></td><td></td><td></td><td></td><td></td><td></td><td class='weekend2'></td></tr></table></div></div></div></div>");	
		}
		var $mhInput = $(this);
		...
		Date_time(nowYear, nowMonth, nowWeek, nowLastday);//初始化为当前日期		
		//上一月绑定点击事件
		$("#preMonth").click(function() {
			...
			Date_time(year, month, week, lastday);
		});		
		//年下拉框的改变事件
		...
		//下一个月的点击事件
		 ...
		 //初始化日历
		 function Date_time(year, month, week, lastday) {
			$("#year").val(year);
			$("#month").val(month)
		...
		$("#calender td").die().live("click",function() {	
			...
			if (dv != "&nbsp;"){
				...
				// $("input.dateVisited").attr('value',str);
		...
		$mhInput.live(options.Event,function(e){											
			...
			// var iof = $(this).offset();	//offset获取匹配元素在当前视口的相对偏移
			// $(".calender").css({ "background-color":"lightblue","position":"absolute","left" : iof.left+options.Left,"top" : iof.top+options.Top });
			$(".calender").css({ "background-color":"lightblue","position":"absolute","left" : options.Left,"top" : options.Top});
